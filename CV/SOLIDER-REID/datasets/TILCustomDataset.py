...
class TILCustomDataset(BaseImageDataset):
    ...
    def __init__(self, root='', INFERENCE_MODE=False, **kwargs):
    ...
    def _check_before_run(self):
        ...
        # Check if the query directory exists. The query directory is used regardless of whether INFERENCE_MODE is True or False.
        if not osp.exists(self.query_dir):
            raise RuntimeError("'{}' is not available".format(self.query_dir))

        # Check if the gallery directory exists. The gallery directory is used regardless of whether INFERENCE_MODE is True or False.
